...
angularApp.service('rateService', function($http,$q){
        ...
        return{
                rateRequestCount: function(){
                        ...
                        $http({method: 'POST', url: '/api/count/rateRequest/'}).
                ...
                chargeList: function(value){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/list/charge/', data:value}).
                                success(function(data, status, headers, config){
                                        if(value === "1")
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                read: function(chargeId){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/read/charge/', data:{"chargeId":chargeId}}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                getChargeDefinitions: function(accId){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/list/chargeDefns', data:{"id":accId}}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                create: function(charge){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/create/charge', data:charge}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                createChargeDefinition: function(d){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/create/chargeDefinition', data:d}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                defaultFieldsList: function(value){
                        ...
                        $http({method: 'POST', url: '/api/read/chargeTemplate', data:{"id":value}}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)                                               
                                            {deferred.resolve(data.msg);}                                        
