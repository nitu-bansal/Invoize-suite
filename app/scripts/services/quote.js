...
angularApp.service('quoteService', function($http,$q){
        ...
        return{
                quoteRequestCount: function(){
                        ...
                        $http({method: 'POST', url: '/api/count/quoteRequest/'}).
                ...
                quoteList: function(value){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/list/quote/', data:value}).
                                success(function(data, status, headers, config){
                                        if(value === "1")
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                read: function(quoteId){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/read/quote/', data:{"quoteId":quoteId}}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                selectionList: function(quoteId){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/list/quote/', data:{"quoteId":quoteId}}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                ...
                getQuoteDefinitions: function(accId){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/list/quoteDefns', data:{"id":accId}}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                create: function(quote){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/create/quote', data:quote}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                createQuoteDefinition: function(d){
                        var deferred = $q.defer();
                        $http({method: 'POST', url: '/api/create/quoteDefinition', data:d}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                                {deferred.resolve(data.msg);}
                                        else
                ...
                defaultFieldsList: function(value){                        
                        ...
                        $http({method: 'POST', url: '/api/read/quoteTemplate', data:{"id":value}}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)                                               
                                            {deferred.resolve(data.msg);}                                        
                ...
                quoteDefnGroups: function(value){
                        ...
                        $http({method: 'POST', url: '/api/list/suggestion/', data:value}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                        {                                                                                    
                                                deferred.resolve([{id:"1",n:"Air",v:""},{id:"2",n:"Ocean",v:""},{id:"3",n:"Ground",v:""}]);
                                        }
                                        else
                                                {deferred.reject(data.msg);}
                                }).
                ...
                quoteDefneffectiveBase: function(value){
                        ...
                        $http({method: 'POST', url: '/api/list/suggestion/', data:value}).
                                success(function(data, status, headers, config){
                                        if(data.result===1)
                                        {                                                                                    
                                                deferred.resolve([{id:"1",n:"Shipment Date",v:""},{id:"2",n:"Actual Date",v:""},{id:"3",n:"Invoice Date",v:""}]);
                                        }
                                        else
                                                {deferred.reject(data.msg);}
                                }).
