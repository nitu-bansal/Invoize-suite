'use strict';
angularApp.controller('tmsCtrl',function($scope,$http,$location,$stateParams,$route,$routeParams,$dialog,accountService,tmsService,sharedService,flash){
        ...
        $scope.create = function(tariff){
                ...
                promise.then(function(msg){
                                ...
                                flash.pop({title: 'Success', body: "Tariff was created successfully", type: 'info'});},
                        function(msg){
                                $scope.tariffCreateLoader = false;
