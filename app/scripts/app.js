(function() {
  ...
  root.angularApp = angular.module("angularApp", ["ui", 'ui.directives', 'ui.compat', 'ngCookies', 'ui.bootstrap', '$strap.directives', 'blueimp.fileupload']).config([
    "$stateProvider", "$routeProvider", "$urlRouterProvider", "$locationProvider", 'fileUploadProvider', function($stateProvider, $routeProvider, $urlRouterProvider, $locationProvider) {
  ...
  root.angularApp.run(function($rootScope, $state, $stateParams, $route, $routeParams, $cookies) {
