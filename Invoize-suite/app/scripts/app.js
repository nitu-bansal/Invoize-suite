(function() {
  ...
  root.angularApp = angular.module("angularApp", ['ngGrid', 'ui2.select2', 'chieffancypants.loadingBar', 'ui', 'angularFileUpload', 'ui.bootstrap', 'ui.directives', 'ui.compat', 'ngCookies', 'blueimp.fileupload', 'restangular', 'ngResource', 'uiHandsontable', 'smartTable.table', 'ngDragDrop', 'ui.layout', 'localytics.directives', 'ui.bestselect']).config([
    "$stateProvider", "$routeProvider", "$urlRouterProvider", "$locationProvider", 'fileUploadProvider', 'RestangularProvider', function($stateProvider, $routeProvider, $urlRouterProvider, $locationProvider, fileUploadProvider, RestangularProvider) {
      ...
      return $stateProvider.state("changePassword", {
        url: "/changePassword",
        ...
        resolve: {
          promiseObj: function($http) {
            return $http.get("api/summaryHeaders");
          }
        },
