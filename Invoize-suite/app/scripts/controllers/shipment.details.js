...
angularApp.controller('shipmentDetailsCtrl', function($scope, $location, flash, $http, $q, $timeout, commonService, $modal, $modalInstance, items) {
    ...
    $scope.getTemplate = function() {
        ...
        // var promise = commonService.ajaxCall('GET', '/api/shipmentField/template?account=' + $scope.items.accountId+'&type='+$scope.items.parentGroup);
        // var promise = commonService.ajaxCall('GET', '/api/shipmentField/template?templateId=' + $scope.items.templateId + '&type=' + $scope.items.parentGroup);
